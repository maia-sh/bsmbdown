...
division: 'Berlin School of Mind and Brain'
supervisorone: 'Primary Supervisor'
supervisortwo: 'Secondary Supervisor'
# If you have more two advisors, un-silence line 7
#altadvisor: 'Your Other Advisor'
department: 'Track Brain'
degree: 'Master of Science (M.Sc.)'
type: "Master's Thesis"
knit: "bookdown::render_book"
site: bookdown::bookdown_site
output: 
  bsmbdown::thesis_pdf: default
#  bsmbdown::thesis_gitbook: default
#  bsmbdown::thesis_word: default
#  bsmbdown::thesis_epub: default
...
# This chunk ensures that the bsmbdown package is
# installed and loaded. This bsmbdown package includes
# the template files for the thesis.
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(bsmbdown))
  devtools::install_github("maia-sh/bsmbdown")
library(bsmbdown)
```
